...
_c = TrickHistory;
// Helper pour transformer le JSON du backend en format CardData pour React
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const handleKeyDown = {
                "Home.useEffect.handleKeyDown": (e)=>{
                    // Si on est en train de taper dans un champ, on ignore
                    if ([
                        'INPUT',
                        'SELECT',
                        'TEXTAREA'
        ...
        currentMoveIndex,
        stats
    ]); // Dépendances importantes pour avoir les valeurs à jour
    ...
    const autoFindSolution = async ()=>{
        // Il faut avoir sélectionné une mission du livre pour savoir quelle structure chercher
        if (bookMissionId === 0) {
            addLog("⚠️ Veuillez sélectionner une mission dans le Livre de Bord d'abord.");
            return;
        }
        // Annulation des processus précédents
        if (abortControllerRef.current) abortControllerRef.current.abort();
        const controller = new AbortController();
        abortControllerRef.current = controller;
        setIsAutoFinding(true);
        addLog("🎰 Recherche d'une donne PARFAITE (Donne + Missions)...");
        const MAX_ATTEMPTS = 500; // On peut tester beaucoup car c'est rapide
        let attempts = 0;
        let found = false;
        // On récupère la définition de la mission (ex: Mission 30 a 6 slots avec tokens 1,2,3,4,5,6)
        ...
        try {
            while(!found && attempts < MAX_ATTEMPTS){
                ...
                attempts++;
                // --- 1. DEMANDER UNE NOUVELLE DONNE VIRTUELLE ---
                // On appelle /start-game pour avoir des mains toutes neuves
                const resDeal = await fetch('http://localhost:8000/start-game', {
                    signal: controller.signal
                });
                if (!resDeal.ok) continue;
                const gameData = await resDeal.json();
                // --- 2. GENERER DES MISSIONS ALEATOIRES SUR CETTE DONNE ---
                // On reconstitue un deck plat pour piocher dedans
                const flatDeck = [];
                [
                    'player_1',
                    'player_2',
                ...
                // Mélange des cartes tâches
                const shuffledTasks = flatDeck.sort(()=>Math.random() - 0.5);
                // Création des missions selon la structure du Livre (Mission 30 etc)
                // On distribue aléatoirement aux joueurs (0..3)
                ...
                if (solveData.stats.solutionFound) {
                    ...
                    // --- 5. MISE A JOUR DE L'INTERFACE ---
                    // A. On affiche la nouvelle donne (cartes en main)
                    const newAllCards = convertBackendToFrontend(gameData);
                    setAllCards(newAllCards);
                    // B. On affiche les nouvelles missions
                    ...
                    // C. On affiche la solution
                    setStats(solveData.stats);
                } else {
                    // Feedback visuel léger tous les 10 essais pour dire "je bosse encore"
                    if (attempts % 10 === 0) addLog(`... Essai ${attempts} échoué ...`);
                }
            }
            if (!found) {
                addLog(`❌ Echec après ${MAX_ATTEMPTS} donnes différentes.`);
            }
        } catch (e) {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        ...
                                                                        children: isAutoFinding ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                            children: "🎲 Recherche de donne gagnante..."
                                                                        }, void 0, false) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                            children: "🎰 Trouver une donne GAGNANTE"
                                                                        }, void 0, false)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/page.tsx",
                                                                        lineNumber: 724,
...
_s(Home, "CtE/n+TtOYY8hn/7smW2KidOwVQ=");
_c1 = Home;
var _c, _c1;
...
//# sourceMappingURL=_7fd4ca9a._.js.map