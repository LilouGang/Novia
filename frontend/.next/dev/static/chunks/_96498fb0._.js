...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$missions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/missions.ts [app-client] (ecmascript)"); // Assure-toi que ce fichier existe
;
...
function Home() {
    ...
    const autoFindSolution = async ()=>{
        if (allCards.length === 0 || missions.length === 0) return;
        // On arrête tout ce qui tourne déjà
        if (abortControllerRef.current) abortControllerRef.current.abort();
        const controller = new AbortController();
        abortControllerRef.current = controller;
        setIsAutoFinding(true);
        addLog("🕵️ Recherche d'une configuration gagnante...");
        const MAX_ATTEMPTS = 200; // Sécurité pour pas tourner à l'infini
        let attempts = 0;
        let found = false;
        // On prépare les mains pour le backend (elles ne bougent pas)
        const handsForBackend = {
            player_1: [],
            player_2: [],
            player_3: [],
        ...
        try {
            while(!found && attempts < MAX_ATTEMPTS){
                // Si l'utilisateur a annulé (ex: changé de page), on stoppe
                if (controller.signal.aborted) break;
                attempts++;
                // --- 1. GENERATION D'UNE MISSION ALEATOIRE (Virtuelle) ---
                // On ne touche pas à l'état React 'missions' pour l'instant, c'est trop lent.
                // On génère juste les données pour le test.
                const validTaskCards = allCards.filter((c)=>c.color !== 'Rocket');
                const shuffledTasks = [
                    ...validTaskCards
                ].sort(()=>Math.random() - 0.5);
                // On crée une variante des missions actuelles avec de nouvelles cartes/proprios
                const testMissions = missions.map((m, i)=>{
                    // Si on a assez de cartes aléatoires, on change la carte cible
                    const newCard = shuffledTasks[i] || {
                        color: m.cardColor,
                        value: m.cardValue
                    };
                    return {
                        ...
                        token: m.token // On GARDE le jeton (l'ordre 1,2,3...)
                    };
                });
                // --- 2. ENVOI AU SOLVER ---
                // On utilise fetch mais sans mettre à jour l'UI graphique lourde
                const res = await fetch('http://localhost:8000/solve-game', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                ...
                if (!res.ok) continue; // Erreur technique, on passe
                const data = await res.json();
                // --- 3. VERIFICATION ---
                if (data.stats.solutionFound) {
                    found = true;
                    addLog(`✅ TROUVÉ ! (Essai ${attempts})`);
                    // C'est gagné ! On met à jour l'interface React pour montrer la solution
                    // 1. On met à jour les missions affichées
            ...
            // Petit délai pour ne pas faire exploser le navigateur
            // await new Promise(r => setTimeout(r, 10)); 
            }
            if (!found) {
                addLog(`❌ Rien trouvé après ${MAX_ATTEMPTS} essais sur cette donne.`);
                addLog("Conseil : Changez la donne (Nouvelle Donne) et réessayez.");
            }
        } catch (e) {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        ...
                                                                        className: `flex-1 py-2 rounded text-[10px] font-bold border transition flex items-center justify-center gap-2 ${isAutoFinding ? 'bg-yellow-900/50 border-yellow-700 text-yellow-200 animate-pulse' : 'bg-gradient-to-r from-yellow-700 to-orange-700 hover:from-yellow-600 hover:to-orange-600 text-white border-orange-500'}`,
                                                                        children: isAutoFinding ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                            ...
                                                                            children: "🕵️ Trouver une config gagnante"
                                                                        }, void 0, false)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/page.tsx",
                                                                        lineNumber: 661,
...
_s(Home, "VyqN4JKhp3w5GnQHs7vp1Ws4f6Y=");
_c1 = Home;
var _c, _c1;
...
//# sourceMappingURL=_96498fb0._.js.map